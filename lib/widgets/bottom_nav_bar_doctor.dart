...
class _BottomNavBarState extends State<BottomNavBarDoctor>
      ...
      child: BottomAppBar(
        ...
        child: SizedBox(
          ...
          child: TabBar(
            ...
            tabs: [
              _buildTab(
                  Icons.calendar_today_outlined, "Shifts", 0, unselectedColor),
              _buildTab(Icons.person, "Profile", 1, unselectedColor),
            ],
          ),
        ),
      ),
